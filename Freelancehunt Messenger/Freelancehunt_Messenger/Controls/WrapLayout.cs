...
namespace Freelancehunt_Messenger.Controls
{
    public class WrapLayout : Layout<View>
    {
        ...
        /// </summary>
        public static readonly BindableProperty OrientationProperty = BindableProperty.Create(propertyName: "Orientation", returnType: typeof(StackOrientation), declaringType: typeof(StackOrientation), defaultValue: StackOrientation.Vertical);
        ...
        /// </summary>
        public static readonly BindableProperty SpacingProperty = BindableProperty.Create(propertyName: "Spacing", returnType: typeof(double), declaringType: typeof(double), defaultValue: 6.0);
